			...
			<div class="p-6 space-y-4">
				...
				<div class="flex items-center justify-between">
					<div>
						...
						<p class="text-sm text-gray-600">
							Current: {$settingsStore.theme === 'light'
								? 'Light'
				...
				<div class="flex items-center justify-between">
					<div>
						...
						<p class="text-sm text-gray-600">
							{$settingsStore.defaultView === 'month'
								? 'Month'
								: $settingsStore.defaultView === 'day'
									? 'Day'
									: 'Year'}
						</p>
					</div>
				...
				{#if $userProfile}
					<div class="pt-4 border-t border-[#f0f2f5]">
						...
						<p class="text-sm text-gray-600">
							...
							{$settingsStore.displayName || $userProfile.name}
						</p>
